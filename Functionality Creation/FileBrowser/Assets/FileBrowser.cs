...
// By Aiden Triffitt on 03/05/2017
...
public class FileBrowser : MonoBehaviour
{
    ...
    {
        string mainFolder = m_input.GetComponentInChildren<InputField>().text;
    ...
    /// <summary>
    /// Opens a file. Created by Aiden Triffitt, under guidance from line [] in this file
    /// </summary>
    /// <param name="fileToOpen"></param>
    void MyOpenFile(string fileToOpen)
    {
        int counter = 0;
        string line;
